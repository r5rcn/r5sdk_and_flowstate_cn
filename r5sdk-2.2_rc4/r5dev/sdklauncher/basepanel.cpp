...
void CSurface::Init()
{
	...
	this->m_DeveloperToggle->SetText("启用开发者模式");
	...
	this->m_PlaylistFileLabel->SetText("Playlists 文件");
	...
	this->m_NetRandomKeyToggle->SetText("网络随机密钥");
	...
	this->m_NoQueuedPacketThread->SetText("无队列数据包");
	...
	this->m_ConsoleSendCommand->SetText("提交");
...
void CSurface::Setup()
{
	...
	this->m_ModeCombo->Items.Add("主机");
	this->m_ModeCombo->Items.Add("服务器");
	this->m_ModeCombo->Items.Add("客户端");

#ifdef DEDI_LAUNCHER
	this->m_ModeCombo->SetSelectedIndex(1);
#endif // DEDI_LAUNCHER

	this->m_VisibilityCombo->Items.Add("公共");
	this->m_VisibilityCombo->Items.Add("隐藏");
	this->m_VisibilityCombo->Items.Add("离线");
}
